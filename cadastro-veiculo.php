      ...
      <div class="cad-total">
        ...
        <div class="button-modais">
          <div class="listar-veiculos">
            ...
            <button type="button" class="btn btn-secondary" data-bs-toggle="modal" data-bs-target="#staticBackdrop1">Listar Veiculos Cadastrados</button>
            <!-- Modal -->
          ...
          <div class="cad-modelo">
            ...
            <button type="button" class="btn btn-secondary" data-bs-toggle="modal" data-bs-target="#staticBackdrop2">Cadastrar Novo Modelo</button>
            <!-- Modal -->
